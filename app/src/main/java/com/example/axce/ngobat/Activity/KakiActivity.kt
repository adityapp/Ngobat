...
import kotlinx.android.synthetic.main.activity_kaki.*

class KakiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rv_kaki.layoutManager = LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false)
        rv_kaki.adapter = adapter
